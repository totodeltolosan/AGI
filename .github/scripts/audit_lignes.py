...
def orchestrer_audit_lignes(limite_lignes: int, exclusions: list) -> bool:
    ...
    try:
        ...
        validation_stats_inputs = {
            "statistiques": "statistiques"
        }
        
        if not appeler_workflow("05-03-lignes-valid-statisticien.yml", validation_stats_inputs):
            return False
        ...
        validation_rapport_inputs = {
            "rapport-lignes": "rapport-lignes"
        }
        
        if not appeler_workflow("05-04-lignes-valid-rapporteur.yml", validation_rapport_inputs):
            return False
        ...
        validation_conseiller_inputs = {
            "recommandations": "recommandations"
        }
        
        if not appeler_workflow("05-05-lignes-valid-conseiller.yml", validation_conseiller_inputs):
            return False
